...
## DEMO
   ...
   [<img src="recursosReadme/Ejecutando.gif" width=1500><br><h3>Ejecutar</h3>](recursosReadme/Ejecutando.gif) 
...
## Como descargar, importacion y ejecutar
   * ### Descargar
      ...
      [<img src="recursosReadme/Descargar.gif" width=350><br><h3>Descarga</h3>](recursosReadme/Descargar.gif)
   ...
   * ### Importacion (Desde " eclipse-workspace ")
      ...
      Nota: "Usuario" es el nombre del usuario de la computadora.
       ...
       [<img src="recursosReadme/Descomprimir.gif" width=350><br><h3>Descomprimir</h3>](recursosReadme/Descomprimir.gif) 
      

      Ahora vamos a importar el proyecto al programa IDE Eclipce, nos vamos a barra de herramientas al apartado      File > Import...

      | [<img src="recursosReadme/Importacion.gif" width=800><br><h3>Importacion</h3>](recursosReadme/Importacion.gif) |  
      | :---: |
   ...
   * ### Ejecutar (un DEMO . JAR)
      ...
      [<img src="recursosReadme/EjecutarDemo.gif" width=800><br><h3>Ejecutar .JAR</h3>](recursosReadme/EjecutarDemo.gif)
